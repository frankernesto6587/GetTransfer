...
export type View = 'dashboard' | 'transferencias' | 'confirmar' | 'reportes' | 'configuracion' | 'usuarios' | 'ayuda'
...
const navItems: NavItem[] = [
  ...
  { icon: ClipboardCheck, label: 'Confirmar', view: 'confirmar', requireConfirm: true },
