...
const MATCH_TYPE_CONFIG: Record<string, { label: string; class: string; codeClass: string }> = {
  ...
  CONFIRMED_MANUAL_CI: { label: 'Manual L3', class: 'bg-cyan-500/15 text-cyan-400', codeClass: 'bg-cyan-500/15 text-cyan-400' },
  CONFIRMED_MANUAL_ACCOUNT: { label: 'Manual L4', class: 'bg-cyan-500/15 text-cyan-400', codeClass: 'bg-cyan-500/15 text-cyan-400' },
